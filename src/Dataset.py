...
class OCTDatasetBase(Dataset):
    def __init__(self,image_path_dir,transform=None):
        ...
        image_DME_paths = glob(os.path.join(image_path_dir,"DME/*.jpeg"))
        image_NORMAL_paths = glob(os.path.join(image_path_dir,"NORMAL/*.jpeg"))
        image_CNV_paths = glob(os.path.join(image_path_dir,"CNV/*.jpeg"))
        image_DRUSEN_paths = glob(os.path.join(image_path_dir,"DRUSEN/*.jpeg"))
